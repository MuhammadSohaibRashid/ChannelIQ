...
import sys
import os
def process_media(file_path, ai_model="IRCNN_Lx1", resize_factor=50, output_path=None, cpu_number=4, keep_frames=False):
    """
    ...
    if not output_path:
        output_path = os.path.join("media", "processed_files")
    ...
    try:
        if check_if_file_is_video(file_path):
            ...
            upscale_video(
                ...
                AI_instance=AI(ai_model, "Auto", resize_multiplier, 10000),
        ...
        return {"processed_file_path": os.path.abspath(processed_file_path)}
